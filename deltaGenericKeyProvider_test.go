...
func TestGenerateWidevinePssh(t *testing.T) {
	...
	data, err := generateWidevinePssh(keyIdInBin, contentIdInBin, "widevine_test", "SD")
...
func TestGenerateMp4Pssh(t *testing.T) {
	contentIdInBin := []byte("test123")
	keyIdInBin := encode.HexStringToBin("eee405eddea64f378e51ec167eca8d33")
	widevinePssh, _ := generateWidevinePssh(keyIdInBin, contentIdInBin, "widevine_test", "SD")

	mp4Pssh, err := generateMp4Pssh(keyIdInBin, "edef8ba979d64acea3c827dcd51d21ed", widevinePssh)
